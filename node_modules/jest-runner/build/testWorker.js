'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\sebas\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.470-universal\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '20cd8e3a8fd82d4fdea172UVMWUB1QAlRTCAYBBFZVVFMFUgcG', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/sebas/.cursor/extensions/wallabyjs.console-ninja-1.0.470-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20cd8e3a8fd82d4fdea172UVMWUB1QAlRTCAYBBFZVVFMFUgcG', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\sebas\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.462-universal\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '206ddbb27f66abbff34f02BFNKV0wDDQVQA1YAVVJeCgxTUVMC', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/sebas/.cursor/extensions/wallabyjs.console-ninja-1.0.462-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '206ddbb27f66abbff34f02BFNKV0wDDQVQA1YAVVJeCgxTUVMC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

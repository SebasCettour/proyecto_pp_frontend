...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\sebas\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.462-universal\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20254fe951933823d1a9deBxsFVlQXBQsJBAYBAFFXB1NbUlcD', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/sebas/.cursor/extensions/wallabyjs.console-ninja-1.0.462-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20254fe951933823d1a9deBxsFVlQXBQsJBAYBAFFXB1NbUlcD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
